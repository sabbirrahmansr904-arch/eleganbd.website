...
async function updateProductImage() {
  try {
    // Find the product
    const product = db.prepare("SELECT id, name FROM products WHERE name LIKE '%Light Ash%'").get();
    if (!product) {
    ...
    const url = 'https://stylisebd.com/wp-content/uploads/2025/12/Formal-Pant-Ash-1-1.webp';
